...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed May 07 20:26:19 CST 2025
  */
    ...
    public void logArithmeticOperation(String operator, String[] e, String[] t, String[] result) {
        ...
        public void procesarCasos(String etiquetaSalida) {
            ...
            for(int i = 0; i < etiquetasCasos.size(); i++) {
                ...
                txtWriter.append(etiquetasCasos.get(i) + ":");
  ...
  public final java_cup.runtime.Symbol CUP$ParserPython$do_action(
    ...
    //System.out.println("\033[1;35mMetodo:"+func.toString()+"\033[0");
     ...
     parser.agregarMetodo(func.toString(), param.toString(), "int", "metodo");
        ...
        parser.txtWriter.append(temp + " = " + el[1] + "  ");
        System.out.println("if " + temp + " goto " + etiquetaCuerpo);
        parser.txtWriter.append("if " + temp + " goto " + etiquetaCuerpo);
        System.out.println("goto " + etiquetaSalida);
        parser.txtWriter.append("goto " + etiquetaSalida);
        ...
        String etiquetaSalida = parser.generador.nuevaEtiqueta();
        String comparacion = temp + " = " + el[1] + "\n"+"if " + temp + " goto " + etiquetaTrue +"\ngoto " + etiquetaSalida;
        System.out.println(comparacion);
        parser.txtWriter.append(comparacion);
        // Bloque if
        System.out.println(etiquetaTrue + ":");
        parser.txtWriter.append(etiquetaTrue + ":");
        ...
        parser.txtWriter.append(etiquetaFalse + ":");
        ...
        parser.txtWriter.append(temp + " = " + e[1] );
        ...
        for(int i = 0; i < parser.arr_case.size(); i++) {
            ...
            if(!caso.equals("_")) {  // "_" representa el caso default
                ...
                String caso_normal = "if " + temp + " == " + caso + " goto " + etiquetaCaso;
                System.out.println(caso_normal);
                parser.txtWriter.append(caso_normal);
            } else {
                tieneDefault = true;
        ...
        if(tieneDefault) {
            ...
            String caso_default = "goto " + parser.etiquetaDefault;
            parser.txtWriter.append(caso_default);
        } else {
            System.out.println("goto " + etiquetaSalida);
            parser.txtWriter.append("goto " + etiquetaSalida);
        }
        ...
        // Etiqueta de salida
        String etiqueta_salida = etiquetaSalida + ":\n"+"goto " + etiquetaSalida;
        parser.txtWriter.append(etiqueta_salida);
